...
// func PutWallet(w *Wallet) *Wallets {
// 	ws := &Wallets{}
...
// func (txs *Txs) FindAllTxsByAddr(Address ecdsa.PrivateKey, bs *blocks) []*Tx {
// 	// Generate empty block
// 	response := []*Tx{}
// 	for _, b := range bs.blockchain {
// 		if b.prevHash == [32]byte{} {
// 			break
// 		} else {
// 			for _, tx := range txs.Txs {
// 				if reflect.DeepEqual(tx.Address, Address) {
